                                        ...
                                        <nav>
                                            <ul class="at-home-navbar-nav real-home-navbar-nav">
                                                ...
                                                @foreach ($menu_items as $index => $item)
                                                    ...
                                                    @if ($index < 2)
                                                        <li>
                                                            <a class="first-a at-home-nav-link {{ $isActive ? 'active' : '' }}" href="{{ $url }}">
                                                ...
                                                <form action="{{ route('ListingsFilter') }}" method="get">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <div class="real-search-filter real-search-filter-border">
                                                            ...
                                                            <select class="at-select2 real-filter-select2 min-w-134px" name="category">
                                                        ...
                                                        <div class="real-search-filter real-search-filter-border">
                                                            ...
                                                            <select class="at-select2 real-filter-select2 min-w-134px" name="city">
                                                ...
                                                <form action="{{ route('ListingsFilter') }}" method="get">
                                                    ...
                                                    <div class="d-flex align-items-center  real-search-filter-wrap">
                                                        <div class="real-search-filter real-search-filter-border">
                                                            ...
                                                            <select class="at-select2 real-filter-select2 min-w-134px min-w-134px" name="category">
                                                                <option value="all">{{ get_phrase('Choose Category') }}</option>
                                                                @foreach ($categories as $index => $category)
                                                                    <option value="{{ $category->id }}">{{ $category->name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="real-search-filter real-search-filter-border">
                                                            ...
                                                            <select class="at-select2 real-filter-select2 min-w-134px min-w-134px" name="city">
                                                                <option value="all">{{ get_phrase('Choose City') }}</option>
                                                                @foreach ($cities as $index => $cityName)
                                                                    @php
                                                                        $city = App\Models\City::where('id', $cityName->city)->first();
