...
<div class="sidebar-nav-area">
    <nav class="sidebar-nav">
        ...
        <ul class="px-14px pb-24px">
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/listings*') || request()->is('admin/listing-create') || request()->is('admin/listing-edit*') || request()->is('admin/listing-store*') || request()->is('admin/verify-listings*') || request()->is('admin/claimed-history*') || request()->is('admin/reported-listings*')  ?'active':''}}">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/verify-listings*') ?'active':''}}"><a href="{{ route('admin.claimed_listings')}}"> {{get_phrase('Varify Listing')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/claimed-history*') ?'active':''}}"><a href="{{ route('admin.claimed_history')}}"> {{get_phrase('Claim History')}} </a></li>
            ...
            {{-- Reviews Reports --}}
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/reviews-reports') || request()->is('admin/reviews') ?'active':''}}">
                <a href="javascript:void(0);">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M3.33734 18.1242C2.9565 18.1242 2.58666 17.9741 2.30666 17.6941C1.91166 17.3 1.77582 16.7275 1.95082 16.2008L2.6515 14.1167C2.73317 13.8608 2.72577 13.6041 2.62994 13.4016C2.13661 12.3408 1.87819 11.1659 1.87819 9.99919C1.87819 5.52002 5.5224 1.875 10.0016 1.875C14.4816 1.875 18.1257 5.51919 18.1257 9.99919C18.1257 14.4792 14.4816 18.1233 10.0016 18.1233C8.83573 18.1233 7.66077 17.8642 6.60577 17.3734C6.39827 17.2742 6.14077 17.2675 5.8766 17.3517L3.80242 18.0483C3.64826 18.0992 3.4915 18.1242 3.33734 18.1242ZM10.0007 3.125C6.21075 3.125 3.12738 6.20835 3.12738 9.99919C3.12738 10.985 3.34655 11.9775 3.76072 12.8692C3.99072 13.3533 4.02069 13.9358 3.83986 14.505L3.13653 16.5975C3.10153 16.7017 3.15483 16.7758 3.18983 16.8108C3.22483 16.8458 3.2999 16.8992 3.40407 16.8642L5.48577 16.165C6.06411 15.9808 6.64739 16.0092 7.13739 16.2433C8.02239 16.655 9.01491 16.8742 10.0007 16.8742C13.7916 16.8742 16.8749 13.7908 16.8749 10C16.8749 6.20917 13.7916 3.125 10.0007 3.125ZM11.9099 13.9583C11.7441 13.9583 11.5783 13.9183 11.4241 13.8383L9.99993 13.095L8.57659 13.8375C8.22159 14.0233 7.79745 13.9917 7.47328 13.755C7.14995 13.5192 6.99154 13.1275 7.05987 12.7342L7.32985 11.1709L6.14333 10.0233C5.86249 9.75168 5.76248 9.35248 5.88332 8.98081C6.00415 8.60831 6.31918 8.34247 6.70668 8.28664L8.35239 8.04998L9.06243 6.62252C9.23993 6.26502 9.59991 6.04167 10.0007 6.04167C10.4007 6.04167 10.7607 6.26418 10.9391 6.62252L11.6491 8.04998L13.295 8.28664C13.6825 8.34247 13.9982 8.60831 14.1182 8.98081C14.239 9.35248 14.1382 9.75168 13.8582 10.0233L12.6716 11.1709L12.9424 12.7358C13.0099 13.1308 12.8507 13.5208 12.5274 13.7567C12.3424 13.89 12.1274 13.9583 11.9099 13.9583ZM9.99993 11.8167C10.1616 11.8167 10.324 11.855 10.4715 11.9325L11.6375 12.5408L11.4157 11.2616C11.3591 10.9291 11.4691 10.5908 11.7116 10.3575L12.6434 9.45669L11.3482 9.27002C11.0182 9.22252 10.7316 9.01585 10.5816 8.71668L9.99831 7.54333L9.41583 8.71501C9.26499 9.01501 8.97906 9.22169 8.6474 9.27002L7.35325 9.45669L8.28586 10.3583C8.52753 10.5908 8.63837 10.9292 8.58087 11.2608L8.35911 12.54L9.52488 11.9325C9.67571 11.855 9.83827 11.8167 9.99993 11.8167ZM7.41835 11.2567C7.41918 11.2567 7.41918 11.2567 7.41835 11.2567V11.2567ZM12.5825 11.2558C12.5817 11.2558 12.5817 11.2558 12.5825 11.2558V11.2558ZM13.1142 9.52332H13.1233H13.1142ZM9.81825 7.17834C9.81825 7.17834 9.81907 7.17919 9.81907 7.18002L9.81825 7.17834Z" fill="#99A1B7"/>
                        </svg>
                    </span>
                    <div class="text">
                ...
                <ul class="first-sub-menu">
                    <li class="sidebar-second-li  {{request()->is('admin/reviews')?'active':''}}">
                        <a href="{{route('admin.reviews')}}">  {{get_phrase('All Reviews')}} </a>
                    </li>
                    <li class="sidebar-second-li  {{request()->is('admin/reviews-reports')?'active':''}}">
                        <a href="{{ route('admin.reviews_reports')}}">  {{get_phrase('Reviews Reports')}} </a>
                    </li>
                </ul>
            </li>
            {{-- Sponser / Adds --}}
            <li class="sidebar-first-li first-li-have-sub {{ request()->is('admin/ads/list') || request()->is('admin/ads/add') ?'active':''}}">
                <a href="javascript:void(0);">
                    <span>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.8 2.41701C20.214 2.13601 19.5341 2.21203 19.0291 2.61903L17.9969 3.44301C16.5399 4.60901 14.71 5.25099 12.845 5.25099H7.5C4.605 5.25099 2.25098 7.60601 2.25098 10.5C2.25098 13.228 4.34896 15.45 7.01196 15.7L9.27698 20.23C9.74598 21.168 10.6891 21.75 11.7371 21.75H13C13.221 21.75 13.43 21.653 13.572 21.485C13.714 21.317 13.776 21.094 13.74 20.877L12.886 15.751C14.737 15.761 16.55 16.4 17.996 17.557L19.026 18.381C19.332 18.625 19.6989 18.75 20.0699 18.75C20.3169 18.75 20.566 18.695 20.799 18.582C21.385 18.301 21.749 17.722 21.749 17.072V3.92702C21.75 3.27802 21.386 2.69901 20.8 2.41701ZM3.75 10.5C3.75 8.43301 5.43202 6.75099 7.49902 6.75099H12.844C13.659 6.75099 14.467 6.646 15.25 6.446V14.554C14.467 14.354 13.658 14.249 12.844 14.249H7.49902C5.43202 14.249 3.75 12.567 3.75 10.5ZM11.736 20.25C11.259 20.25 10.831 19.985 10.618 19.559L8.71301 15.749H11.364L12.114 20.25H11.736ZM20.25 17.072C20.25 17.145 20.217 17.199 20.15 17.231C20.084 17.262 20.019 17.256 19.963 17.21L18.933 16.386C18.264 15.851 17.528 15.412 16.749 15.072V5.92799C17.527 5.58799 18.263 5.149 18.932 4.61501L19.964 3.78999C20.02 3.74499 20.082 3.737 20.15 3.769C20.195 3.791 20.25 3.83599 20.25 3.92799V17.072Z" fill="#99A1B7"/>
                        </svg>
                    </span>
                    <div class="text">
                        <span> {{get_phrase('Sponsored Post')}} </span>
                    </div>
                </a>
                <ul class="first-sub-menu">
                    <li class="sidebar-second-li  {{request()->is('admin/ads/list') || request()->is('admin/ads/add') ?'active':''}}">
                        <a href="{{route('admin.ads')}}">  {{get_phrase('Ads List')}} </a>
                    </li>
                </ul>
            </li>
            {{-- Sponser / Adds --}}
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/shop*') || request()->is('admin/order-manager*')  || request()->is('admin/inventory-myorder') ?'active':''}}">
                <a href="javascript:void(0);">
                    ...
                    <div class="text">
                        <span> {{get_phrase('Shop')}} </span>
                    </div>
                </a>
                <ul class="first-sub-menu">
                    <li class="sidebar-second-li {{request()->is('admin/shop/statistics')?'active':''}}"><a href="{{ route('admin.shop.statistics')}}"> {{get_phrase('Statistics')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/products')?'active':''}}"><a href="{{ route('admin.shop.products')}}"> {{get_phrase('All Products')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/product/create')?'active':''}}"><a href="{{ route('admin.shop.product.create')}}"> {{get_phrase('Add Product')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/categories')?'active':''}}"><a href="{{ route('admin.shop.categories')}}"> {{get_phrase('Categories')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/orders')?'active':''}}"><a href="{{ route('admin.shop.orders')}}"> {{get_phrase('Orders')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/reviews')?'active':''}}"><a href="{{ route('admin.shop.reviews')}}"> {{get_phrase('Reviews')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/coupons')?'active':''}}"><a href="{{ route('admin.shop.coupons')}}"> {{get_phrase('Coupons')}} </a></li>
                    <li class="sidebar-second-li {{request()->is('admin/shop/inventory')?'active':''}}"><a href="{{ route('admin.shop.inventory')}}"> {{get_phrase('Inventory')}} </a></li>
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/service_manager*')  || request()->is('admin/service/myservice') || request()->is('admin/employee/list') ?'active':''}}">
                <a href="javascript:void(0);">
                    <span>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="text">
                        <span> {{get_phrase('Service Selling')}} </span>
                    </div>
                </a>
                <ul class="first-sub-menu">
                    <li class="sidebar-third-li {{request()->is('admin/service_manager')?'active':''}}"><a href="{{route('admin.service.manager')}}"> {{get_phrase('Service Manager')}} </a></li>
                    <li class="sidebar-third-li {{request()->is('admin/all-services')?'active':''}}"><a href="{{ route('admin.all_services')}}"> {{get_phrase('All Services')}} </a></li>
                    <li class="sidebar-third-li {{request()->is('admin/service/myservice')?'active':''}}"><a href="{{ route('admin.service.myservice')}}"> {{get_phrase('My Services')}} </a></li>
                    <li class="sidebar-third-li {{request()->is('admin/employee/list')?'active':''}}"><a href="{{ route('admin.employee.list')}}"> {{get_phrase('All Employees')}} </a></li>
                </ul>
            </li>
            @endif
            {{-- Service Addon --}}
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/blogs/all') || request()->is('admin/blogs/pending') || request()->is('admin/blog-category') || request()->is('admin/blog-create') || request()->is('admin/blog-permission')?'active':''}}">
                <a href="javascript:void(0);">
                    <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/blog-permission')?'active':''}}"><a href="{{ route('admin.blog-permission')}}"> {{get_phrase('Blog Setting')}} </a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/system-setting') || request()->is('admin/language-setting') || request()->is('admin/email-settings') || request()->is('admin/website-setting') || request()->is('admin/language-phrase*') || request()->is('admin/payment-edit*') || request()->is('admin/payment-gateways*') || request()->is('admin/live-chat/tawk-settings*') || request()->is('admin/form-builder*') || request()->is('admin/calendly/settings*')   || $current_route == 'admin.seo.settings' || $current_route == 'admin.about' ?'active':''}}">
                <a href="javascript:void(0);">
                   <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/gamification-badge-settings')?'active':''}}"><a href="{{ route('admin.gamification.settings')}}"> {{get_phrase('Gamification Badges')}} </a></li>
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/calendly/settings') ?'active':''}}"><a href="{{route('admin.calendly.settings')}}"> {{get_phrase('Calendly Settings')}} </a></li>
                    @endif
