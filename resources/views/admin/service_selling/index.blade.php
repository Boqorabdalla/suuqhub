                                ...
                                <div class="d-flex ">
                                     <div class="dropdown ol-icon-dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end at-dropdown-menu">
                                            <li><a class="dropdown-item fs-14px" onclick="modal('modal-lg','{{route('admin.service.edit',['type' => $type, 'listing_id'=>$listing->id,'id'=>$selling->id])}}','{{get_phrase('Update Service')}}')" href="javascript:void(0);"> {{get_phrase('Edit')}} </a></li>
                                            <li><a class="dropdown-item fs-14px" onclick="delete_modal('{{route('admin.service.delete',[ 'id'=>$selling->id])}}')" href="javascript:void(0);"> {{get_phrase('Delete')}} </a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
