...
<div class="mb-2">
    <a href="{{ route('admin.shop.approval') }}" class="btn btn-outline-secondary">
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="ol-card mb-3">
            ...
            <div class="ol-card-body">
                <form action="{{ route('admin.shop.approval.approve', $order->id) }}" method="POST" class="mb-2">
                    @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.shop.approval.reject', $order->id) }}" method="POST">
                @csrf
