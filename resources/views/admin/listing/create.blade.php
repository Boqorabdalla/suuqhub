    ...
    <div class="ol-card-body my-2 py-20px px-20px">
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
            ...
            <div class="d-flex gap-2">
                <a href="{{ asset('listing-bulk.csv') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px" target="_blank" download >
                    <span class="fi-rr-upload"></span>
                    <span> {{get_phrase('Preview Bulk Download')}} </span>
                </a>
                <a href="javascript:void(0)" onclick="modal('modal-lg', '{{route('admin.bulk_listing_upload')}}', '{{get_phrase('Bulk Upload')}}')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                    <span class=" fi-rr-cloud-upload-alt"></span>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <select name="type" id="listing-type" class="form-control ol-select2 ol-form-control" >
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <select name="category" id="listing-category" class="form-control ol-select2 ol-form-control" >
