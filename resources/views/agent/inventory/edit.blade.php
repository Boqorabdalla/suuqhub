            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ get_phrase('Edit Inventory Item') }}</h4>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" required value="{{ $inventory->name }}" placeholder="{{ get_phrase('Enter item name') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="description" class="form-control" rows="4" placeholder="{{ get_phrase('Enter description') }}">{{ $inventory->description }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price" class="form-control" required min="0" step="0.01" value="{{ $inventory->price }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">{{ get_currency_symbol() }}</span>
                                            <input type="number" name="discount_price" class="form-control" min="0" step="0.01" value="{{ $inventory->discount_price }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="stock_quantity" class="form-control" min="0" value="{{ $inventory->stock_quantity }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">{{ get_phrase('SKU / Reference') }}</label>
                                        <input type="text" name="sku" class="form-control" value="{{ $inventory->sku }}" placeholder="{{ get_phrase('Enter SKU') }}">
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <div class="form-check">
                                        <input type="checkbox" name="track_stock" class="form-check-input" id="trackStock" value="1" {{ $inventory->track_stock ? 'checked' : '' }}>
                                        <label class="form-check-label" for="trackStock">{{ get_phrase('Track stock quantity') }}</label>
                                    </div>
                                    <div class="form-check mt-2">
                                        <input type="checkbox" name="availability" class="form-check-input" id="availability" value="1" {{ $inventory->availability ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <div class="mb-3">
                                    <label class="form-label">{{ get_phrase('Change Featured Image') }}</label>
                                    <input type="file" name="featured_image" class="form-control" accept="image/*">
                                    <small class="text-muted">{{ get_phrase('Leave empty to keep current image') }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <button type="submit" class="btn btn-primary w-100 mb-2">
                                    <i class="bi bi-check-circle me-2"></i>{{ get_phrase('Update Item') }}
                                </button>
                                <a href="{{ route('agent.inventory.delete', $inventory->id) }}" class="btn btn-danger w-100" onclick="return confirm('Are you sure you want to delete this item?')">
                                    <i class="bi bi-trash me-2"></i>{{ get_phrase('Delete Item') }}
                                </a>
                            </div>
                        </div>
                    </div>
