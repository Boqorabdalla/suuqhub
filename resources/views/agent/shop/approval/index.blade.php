...
@section('title', get_phrase('Approve Inventory Orders'))
    ...
    <div class="ol-card-body my-2 py-18px px-20px">
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
            <h4 class="title fs-16px">
                ...
                {{ get_phrase('Approve Inventory Orders') }}
            </h4>
...
<div class="ol-card mt-3">
    <div class="ol-card-body p-20px">
        <div class="alert alert-info mb-3">
            ...
            {{ get_phrase('These are orders for products from your listings. Approve them to send to admin for delivery management.') }}
        </div>

        <form action="{{ route('agent.shop.approval') }}" method="get" class="mb-3">
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('agent.shop.approval.show', $order->id) }}" class="btn btn-sm btn-outline-primary">
                                <i class="fi-rr-eye"></i>
                            </a>
                        </td>
                    </tr>
