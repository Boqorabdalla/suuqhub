        ...
        <div class="row row-28 mb-90 mt-3">
            ...
            <div class="col-lg-8">
                <div class="aGdescription">
                    ...
                    {{-- Agent Badges  --}}
                    <h3 class="ca-title-18px mt-30px mb-4">{{get_phrase('Agent Badges')}}</h3>
                    <div class="d-flex gap-3 flex-wrap">
                        @forelse ($agentBadges as $field => $badges)
                            @foreach ($badges as $badge)
                            <div class="agent-details-badge" data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="<h4 class='dm-text-16px text-center text-white'>{{ $badge->title }}</h4>
                                    <p class='text-white text-center'>{{ $badge->value_from }} To {{ $badge->value_to }} - {{ ucfirst(str_replace('_', ' ', $badge->field)) }}</p>">
