...
@push('title', get_phrase('Car list'))
@push('meta')@endpush
                    ...
                    <div class="col-xl-12">
                        <div class="car-list-card d-flex">
                            ...
                            <div class="car-list-details position-relative">
                                <div class="carlist-title-bookmark Cgray  Cgray2 d-flex align-items-start justify-content-between">
                                    ...
                                    data-bs-title="{{ $is_in_wishlist ? get_phrase('Remove from Wishlist') : get_phrase('Add to Wishlist') }}"  onclick="updateWishlist(this, '{{ $listing->id }}')" class="grid-list-bookmark gray-bookmark2 z-9 {{ $is_in_wishlist ? 'active' : '' }}">
                                ...
                                <div class="carlist-item-price d-flex align-items-center justify-content-between">
                                    <ul class="carlist-list-items d-flex align-items-center flex-wrap">
                                        <li>
                                            ...
                                            <p class="info"> {{App\Models\Amenities::where('id', $listing->engine_size)->first()->name ?? 'N/A'}} </p>
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images/icons/mileage-black-24.svg')}}" alt="">
                                            <p class="info"> {{$listing->mileage ?? 'N/A'}} </p>
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images/icons/petrol-black-24.svg')}}" alt="">
                                            <p class="info"> {{App\Models\Amenities::where('id', $listing->fuel_type)->first()->name ?? 'N/A'}} </p>
                                        </li>
                                    </ul>
                                ...
                                <div class="carlist-tag-view d-flex align-items-end justify-content-between flex-wrap">
                                    <ul class="carlist-tag-list d-flex align-items-center flex-wrap">
                                        <li><a href="javascript:;" class="car-tag-item">{{ucwords(App\Models\Category::where('id',$listing->category)->first()->name)}}</a></li>
                                    </ul>
                                    <a href="{{route('listing.details',['type'=>'car', 'id'=>$listing->id, 'slug'=>slugify($listing->title)])}}" class="btn ca-btn-dark ca-btn-sm stretched-link">
