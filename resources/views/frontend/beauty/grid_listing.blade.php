...
@push('title', get_phrase('Beauty Grid'))
@push('meta')@endpush
                                ...
                                <div class="single-grid-card">
                                    ...
                                    <div class="beauty-grid-details position-relative">
                                        ...
                                        <div class="beauty-grid-btns d-flex align-items-center justify-content-between flex-wrap">
                                            <a href="{{route('listing.details',['type'=>$type, 'id'=>$listing->id, 'slug'=>slugify($listing->title)])}}" class="small-border-btn1 ">{{ucwords(App\Models\Category::where('id',$listing->category)->first()->name)}}</a>
