...
<form id="ajax-modal" action="{{route('agent.service.update', ['id' => $serviceSelling->id])}}" method="post" class="e_services" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
        <label for="name" class="form-label ol-form-label cap-form-label"> {{get_phrase('Service Name')}} </label>
        <input type="text" class="form-control ol-form-control cap-form-control" name="name" id="name" value="{{$serviceSelling->name}}" placeholder="{{get_phrase('Enter Service name')}}" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
        ...
        <select class="form-control ol-form-control ol-select2" name="employee[]"   multiple required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control ol-form-control cap-form-control" name="video" id="video" value="{{$serviceSelling->video}}" placeholder="{{ get_phrase('Paste a YouTube video link here') }}" required>
    </div>
      <div class="mb-3">
            <label for="status" class="form-label ol-form-label cap-form-label"> {{get_phrase('Status')}} </label>
            <select name="status" id="status" class="form-control ol-form-control cap-form-control" required>
            ...
            <div class="mb-3">
                ...
                <div id="slot-container">
                    ...
                    <div class="row mb-2 slot-row">
                        <div class="col-md-4">
                            <select name="slots[{{ $index }}][day]" class="form-control ol-form-control cap-form-control" style="height: 46px;" required>
