...
@push('title', get_phrase('Service Manager'))
@push('meta')@endpush
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="d-flex align-items-start justify-content-between gap-2 mb-20px">
                    <div class="d-flex justify-content-between align-items-start gap-12px flex-column flex-lg-row w-100">
                        <h1 class="ca-title-18px">{{get_phrase('Service Manager')}}</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb cap-breadcrumb">
                                ...
                                <li class="breadcrumb-item cap-breadcrumb-item active" aria-current="page">{{get_phrase(' Service Manager')}}</li>
                            </ol>
                        </nav> 
                    </div>
                    ...
                    <div class="table-responsive pb-1">
                        <table class="table ca-table ca-table-width">
                            ...
                            <tbody class="ca-tbody" style="vertical-align: inherit;">
                                @php $num = 1 @endphp
                                @foreach ($serviceManager as $key => $service)
                                 @php
                                ...
                                <tr class="ca-tr">
                                 ...
                                 <td class="ca-subtitle-14px ca-text-dark min-w-142px">
                                ...
                                <td>
                                     <div class="min-w-140px ca-subtitle-14px ca-text-dark">
                                        ...
                                        <p >{{get_phrase('Email : ')}} {{$service->email}}</p>
                                  ...
                                  <td>
                                     <div class="ca-subtitle-14px ca-text-dark min-w-142px">
                                      ...
                                      <div class="d-flex justify-content-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end at-dropdown-menu">
                                               @if($service->payment_status == 1) 
                                                <li>
                                                    <a class="dropdown-item" onclick="delete_modal('{{route('agent.service_manager.unpaid',['id'=>$service->id])}}')" href="javascript:void(0)">{{get_phrase('Mark as Unpaid')}}</a>
                                                </li>
                                                @else
                                                <li>
                                                    <a class="dropdown-item" onclick="delete_modal('{{route('agent.service_manager.paid',['id'=>$service->id])}}')" href="javascript:void(0)">{{get_phrase('Mark as Paid')}}</a>
                                                </li>
                                                @endif
                                                <li>
                                                    <a class="dropdown-item" onclick="delete_modal('{{route('agent.service_manager.approve',['id'=>$service->id])}}')" href="javascript:void(0)">{{get_phrase('Approve')}}</a>
                                                </li>
                                             <li>
                                                <a class="dropdown-item" onclick="delete_modal('{{route('agent.service_manager.delete',['id'=>$service->id])}}')" href="javascript:void(0)">{{get_phrase('Delete')}}</a>
                                              </li>
                                            </ul>
                                        </div>
                                      </div>
                        ...
                        <div class="mt-20px d-flex align-items-center gap-3 justify-content-between flex-wrap ePagination">
                            <p class="in-subtitle-12px">{{get_phrase('Showing').'  to '.count($serviceManager).' '.get_phrase('of').' '.count($serviceManager).' '.get_phrase('results')}} </p>
