                        ...
                        <table class="table ca-table ca-table-width">
                            <thead class="ca-thead">
                              <tr class="ca-tr">
                                    ...
                                    <th scope="col" class="ca-title-14px ca-text-dark">{{ get_phrase('Amount Payable') }}</th>
                                ...
                                <tr class="ca-tr">
                                  ...
                                  <td> 
                                        <div class="ca-subtitle-14px ca-text-dark min-w-140px">
                                            <p>{{get_phrase('Amount Pay : ')}} {{currency($serviceinfo->price)}}</p>
                                              <p >{{get_phrase('Status : ')}}
                                      ...
                                      <div class="d-flex justify-content-center">
                                          <div class="dropdown">
                                              ...
                                              <ul class="dropdown-menu dropdown-menu-end at-dropdown-menu">
                                                  <li><a class="dropdown-item" onclick="delete_modal('{{route('agent.service_manager.delete',['id'=>$service->id])}}')" href="javascript:void(0)">{{get_phrase('Delete')}}</a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </td>
