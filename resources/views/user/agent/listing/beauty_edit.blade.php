                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-basic-info" role="tabpanel" aria-labelledby="pills-basic-info-tab" tabindex="0">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="3" class="form-control cap-form-control" placeholder="{{ get_phrase('Enter listing description') }}">{!! htmlspecialchars($listing->description, ENT_QUOTES, 'UTF-8') !!}</textarea>
                                    </div>
                                    <div class="mb-2">
                                ...
                                @if (addon_status('service_selling') == 1)
                                    <div class="tab-pane fade" id="serviceSelling" role="tabpanel" aria-labelledby="serviceSelling-tab">
                                        ...
                                        <div class="agent_service">
                                            @include('user.agent.service_selling.index', ['type' => $type, 'listing' => $listing])
                                        </div>
                                    </div>
                                @endif
                            {{-- Service Selling  --}}
