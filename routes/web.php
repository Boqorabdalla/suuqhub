...
use App\Http\Controllers\Admin\ShopSubscriptionController;
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    // Shop Subscription Plans Management
    Route::get('/shop-subscriptions/plans', [ShopSubscriptionController::class, 'plans'])->name('admin.shop.subscriptions.plans');
    Route::get('/shop-subscriptions/create-plan', [ShopSubscriptionController::class, 'createPlan'])->name('admin.shop.subscriptions.create_plan');
    Route::post('/shop-subscriptions/store-plan', [ShopSubscriptionController::class, 'storePlan'])->name('admin.shop.subscriptions.store_plan');
    Route::get('/shop-subscriptions/edit-plan/{plan}', [ShopSubscriptionController::class, 'editPlan'])->name('admin.shop.subscriptions.edit_plan');
    Route::put('/shop-subscriptions/update-plan/{plan}', [ShopSubscriptionController::class, 'updatePlan'])->name('admin.shop.subscriptions.update_plan');
