        ...
        <div class="row gx-20px">
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="ca-content-card p-4 position-relative">
                    ...
                    <form action="{{route('user.listing.update',['type'=>'hotel','id'=>$listing->id])}}" id="form-action" method="post" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-features" role="tabpanel" aria-labelledby="pills-features-tab" tabindex="0">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h5 class="form-label cap-form-label mb-3"> {{get_phrase('Add some listing feature')}} </h5>
                            </div>
                            @php
                        ...
                        <div class="tab-pane fade show {{$tab == 'room' ? 'active':''}}" id="pills-rooms" role="tabpanel" aria-labelledby="pills-rooms-tab" tabindex="0">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h5 class="form-label cap-form-label mb-3"> {{get_phrase('Add some Room')}} </h5>
                        ...
                        <div class="tab-pane fade" id="customField" role="tabpanel" aria-labelledby="customField-tab">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div>
                                    ...
                                    <a href="javascript:void(0);" onclick="modal('modal-md', '{{ route('agent.section.sorting', ['prefix' => 'agent', 'type' => 'hotel','listing_id' => $listing->id]) }}', '{{ get_phrase(' Sort Section') }}')" class="btn ol-btn-primary fs-14px"> {{ get_phrase('Sorting') }} </a>
                                    @endif
                                    <a href="javascript:void(0);" onclick="modal('modal-md', '{{ route('agent.custom-field.create', ['prefix' => 'agent', 'type' => 'hotel','listing_id' => $listing->id]) }}', '{{ get_phrase('Add Custom Section') }}')" class="btn ol-btn-primary fs-14px"> {{ get_phrase('Add Type') }} </a>
                                </div>
                            </div>
