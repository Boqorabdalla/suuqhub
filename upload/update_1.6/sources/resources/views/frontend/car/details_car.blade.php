                                ...
                                <ul class="car-overview-items">
                                    ...
                                    <li class="car-overview-item">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->drive_train)->first()->name ?? 'N/A' }}</p>
                                        </div>
                                    </li>
                                    <li class="car-overview-item">
                                        <div class="icon">
                                ...
                                <ul class="car-overview-items">
                                    <li class="car-overview-item">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->transmission)->first()->name ?? 'N/A'}}</p>
                                        </div>
                                    </li>
                                    <li class="car-overview-item">
                                        <div class="icon">
                                    ...
                                    <li class="car-overview-item">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->interior_color)->first()->name  ?? 'N/A'}}</p>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="car-overview-items">
                                    <li class="car-overview-item">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->trim)->first()->name  ?? 'N/A'}}</p>
                                        </div>
                                    </li>
                                    <li class="car-overview-item">
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->exterior_color)->first()->name  ?? 'N/A'}}</p>
                                        </div>
                                    </li>
                                    <li class="car-overview-item">
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="info-value">{{ App\Models\Amenities::where('id', $listing->fuel_type)->first()->name ?? 'N/A' }}</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="alm-header-title-wrap d-flex align-items-center justify-content-between">
                            ...
                            <ul class="alm-hlist-group align-items-center d-flex">
                                ...
                                <li class="alm-hlist-item align_self">
                                    ...
                                    <h4 class="alm-hlist-title">{{ App\Models\Amenities::where('id', $listing->drive_train)->first()->name ?? 'N/A' }}</h4>
                                </li>
                                <li class="alm-hlist-item align_self">
                                    <img src="{{ asset('assets/frontend/images/icons/stock-32.svg') }}" alt="">
                                ...
                                <li class="alm-hlist-item align_self">
                                    ...
                                    <h4 class="alm-hlist-title">{{ App\Models\Amenities::where('id', $listing->transmission)->first()->name ?? 'N/A'}}</h4>
                                </li>
                                <li class="alm-hlist-item align_self">
                                    <img src="{{ asset('assets/frontend/images/icons/mileage-32.svg') }}" alt="">
                                ...
                                <li class="alm-hlist-item align_self">
                                    ...
                                    <h4 class="alm-hlist-title">{{ App\Models\Amenities::where('id', $listing->interior_color)->first()->name ?? 'N/A'}}</h4>
                                </li>
                            ...
                            <div class="car-grid-details position-relative">
                                ...
                                <ul class="cargrid-list-items d-flex align-items-center flex-wrap">
                                    <li>
                                        ...
                                        <p class="info"> {{ App\Models\Amenities::where('id', $listings->engine_size)->first()->name ?? 'N/A' }} </p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <p class="info"> {{ App\Models\Amenities::where('id', $listings->fuel_type)->first()->name ?? 'N/A' }} </p>
                                    </li>
                                </ul>
