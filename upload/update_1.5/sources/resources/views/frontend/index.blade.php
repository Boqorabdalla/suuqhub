                                        ...
                                        @elseif($type->slug == 'restaurant')
                                            <div class="atn-search-content">
                                                ...
                                                <div class="atn-single-search-item">
                                                    ...
                                                    <select id="country-{{ $type->slug }}" class="at-nice-select transparent2-nice-select mh-filter-select" name="country">
                                                ...
                                                <div class="atn-single-search-item afNone">
                                                    <label class="atn-search-filter-label">{{ get_phrase('City') }}</label>
                                                    <select id="city-{{ $type->slug }}" class="at-nice-select transparent2-nice-select mh-filter-select" name="city">
