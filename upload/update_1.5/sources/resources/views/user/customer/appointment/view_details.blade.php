@if ($type == 'phone')
    <div class="position-relative eFlex">
        <a href="tel:{{$appointment->phone}}" class="text-center"><i class="fas fa-phone-volume "></i> {{$appointment->phone}} </a>
        <a href="tel:{{$appointment->phone}}" class="CommonCall">{{ get_phrase('Call') }}</a>
    </div>
@elseif ($type == 'email')
    <div class="position-relative eFlex">
        <a href="mailto:{{$appointment->email}}" class="text-center"><i class="fas fa-envelope-open-text"></i> {{$appointment->email}}</a>
        <a href="mailto:{{$appointment->email}}" class="CommonCall">{{ get_phrase('Send Email') }}</a>
    </div>
@elseif($type == 'zoom')
